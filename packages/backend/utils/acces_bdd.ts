...
export async function deleteSmt(
  table: string,
  ...
  return new Promise((resolve, reject) => {
    ...
    if (conditionKeys.length === 0) {
      return reject(
        new Error("Aucune condition spécifiée pour la suppression.")
      );
    }
...
export async function getPlats_Ingredients_Client(
  data: boolean | any = false,
  all = false,
  str = false,
  limit: boolean | number = 10
...
export async function getPlats_Client(
  data: boolean | any = false,
  all = false,
  str = false,
  limit: boolean | number = 10
...
export async function getMenus_Client(
  data: boolean | any = false,
  all = false,
  str = false,
  limit: boolean | number = 10
...
export async function getRecherches_Client(
  data: boolean | any = false,
  all = false,
  str = false,
  limit: boolean | number = 10
...
export async function getRestaurant_Client(
  data: boolean | any = false,
  all = false,
  str = false,
  limit: boolean | number = 10
...
export async function getRecherche(
  data: boolean | any = false,
  all = false
): Promise<any[] | undefined> {
...
export async function getDesigne_Tags(
  data: boolean | any = false,
  all = false
): Promise<any[] | undefined> {
...
export async function getElementsPlatsAfter(
  data: any,
  after = true
): Promise<any[]> {
  await initDB();
...
export async function updatePlats_Client(
  data: any,
  query: string
): Promise<number> {
...
export async function addPlats_Client(
  data: boolean | any = false
): Promise<number> {
...
export async function addPlats_Ingredients_Client(
  data: boolean | any = false
): Promise<number> {
  const res: number = await addSmt("Plats_Ingredients_Client", data);
  return res;
}
export async function addMenus_Client(
  data: boolean | any = false
): Promise<number> {
  const res: number = await addSmt("Menus_Client", data);
  return res;
}
export async function addRestaurant_Client(
  data: boolean | any = false
): Promise<number> {
  const res: number = await addSmt("Restaurants_Client", data);
  return res;
}
export async function addRecherches_Client(
  data: boolean | any = false
): Promise<number> {
...
export async function addDesigne_Tags(
  data: boolean | any = false
): Promise<number> {
...
export async function deletePlats_Ingredients_Client(
  query: Record<string, any>
): Promise<number> {
  const res: number = await deleteSmt("Plats_Ingredients_Client", query);
  return res;
}
export async function deletePlats_Client(
  query: Record<string, any>
): Promise<number> {
...
export async function deleteSous_Groupes(
  query: Record<string, any>
): Promise<number> {
  const res: number = await deleteSmt("Sous_Groupes", query);
  return res;
}
export async function deleteGroupes(
  query: Record<string, any>
): Promise<number> {
...
export async function deleteRecherche(
  query: Record<string, any>
): Promise<number> {
  const res: number = await deleteSmt("Recherche", query);
  return res;
}
export async function deleteHistorique(
  query: Record<string, any>
): Promise<number> {
...
export async function deleteDesigne_Tags(
  query: Record<string, any>
): Promise<number> {
