...
export default function menus() {
  ...
  async function loadsplats() {
    if (
      typeof params.ID_menu === "string" &&
      typeof params.ID_restaurant === "string"
    ) {
      const ID_menu = parseInt(params.ID_menu);
      const ID_restaurant = parseInt(params.ID_restaurant);
      const resto = await getRestaurants_Historique(
      ...
      const texts = [];
      for (const obj of textrequested) {
        texts.push(obj.text);
      }
